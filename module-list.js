(function(){
    ...
    "online-questionnaire-app-spardac":   {url:"$H/oq.html"},
        ...
        "evening-wordpairs-set1-practice":       {url:"$H/m/word-pairs/evening-wordpairs-set1-practice.html",Table:"wordpairs-set1-practice"},
        "evening-wordpairs-set2-practice":       {url:"$H/m/word-pairs/evening-wordpairs-set1-practice.html",Table:"wordpairs-set1-practice"},
        "evening-wordpairs-set1-trial1":       {url:"$H/m/word-pairs/evening-wordpairs-set1-trial1.html"},
        "evening-wordpairs-set1-trial2":       {url:"$H/m/word-pairs/evening-wordpairs-set1-trial2.html",Table:"wordpairs-set1-trial2"},
        "evening-wordpairs-set1-trial3":       {url:"$H/m/word-pairs/evening-wordpairs-set1-trial3.html",Table:"wordpairs-set1-trial3"},
        "evening-wordpairs-set2-trial1":       {url:"$H/m/word-pairs/evening-wordpairs-set2-trial1.html",Table:"wordpairs-set1-trial1"},
        "evening-wordpairs-set2-trial2":       {url:"$H/m/word-pairs/evening-wordpairs-set2-trial2.html",Table:"wordpairs-set1-trial2"},
        "evening-wordpairs-set2-trial3":       {url:"$H/m/word-pairs/evening-wordpairs-set2-trial3.html",Table:"wordpairs-set1-trial3"},
        "morning-wordpairs-set1":       {url:"$H/m/word-pairs/morning-wordpairs-set1.html",Table:"wordpairs-set1-morning"},
        "morning-wordpairs-set2":       {url:"$H/m/word-pairs/morning-wordpairs-set2.html",Table:"wordpairs-set2-morning"},
        ...
        "finger-tapping6-after-form-30":            {url:"$H/m/neurocog/finger-tapping6-after-form_30s.html",Table:"finger-tapping-spardac",Table2:"finger-tapping12-spardac-30",task_name:"Finger Tapping - Morning 30 seconds"},
        "finger-tapping6-after-form-5":            {url:"$H/m/neurocog/finger-tapping6-after-form_5s.html",Table:"finger-tapping-spardac",Table2:"finger-tapping12-spardac-5",task_name:"Finger Tapping - Morning 5 seconds"},
